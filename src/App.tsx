...
import { assertValidSimulationResult } from './services/resultValidation';
  ...
  const handleStartSimulation = async () => {
    ...
    const performRequest = async (attempt: number): Promise<void> => {
      try {
        ...
        const data = assertValidSimulationResult(
          await generateLifeSimulation(themeLabel, userInput, profile),
          "AI service"
        );
