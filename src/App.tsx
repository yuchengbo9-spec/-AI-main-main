...
export default function App() {
  ...
  const activeSimulationId = useRef(0);
  ...
  const handleStartSimulation = async () => {
    ...
    const requestId = activeSimulationId.current + 1;
    activeSimulationId.current = requestId;
    const isActiveRequest = () => activeSimulationId.current === requestId;
