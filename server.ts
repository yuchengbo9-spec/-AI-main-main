  ...
  app.post("/api/ai/simulation", async (req, res) => {
    ...
    try {
      ...
      if (cached) {
        ...
        return res.json(assertIsSimulationResult(cached, "cached simulation response"));
      }
      ...
      if (PRESET_RESPONSES[input]) {
        ...
        return res.json(assertIsSimulationResult(PRESET_RESPONSES[input], "preset simulation response"));
      }
      ...
      finalResult = assertIsSimulationResult(finalResult, "AI simulation response");
