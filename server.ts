...
import { assertValidSimulationResult, isValidSimulationResult } from "./src/services/resultValidation";
...
async function startServer() {
  ...
  app.post("/api/ai/simulation", async (req, res) => {
    ...
    if (PRESET_RESPONSES[input]) {
      ...
      return res.json(assertValidSimulationResult(PRESET_RESPONSES[input], "Preset response"));
    }
    ...
    try {
      ...
      finalResult = assertValidSimulationResult(finalResult, "AI response");
